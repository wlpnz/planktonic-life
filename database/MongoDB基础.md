...
## 1.3 体系结构
MySQL和MongoDB对比
![](images/MongoDB基础/image-20240418155854409.png)
![](images/MongoDB基础/image-20240418155912238.png)
...
BSON数据类型参考列表：
![](images/MongoDB基础/image-20240418155953091.png)
提示：
shell默认使用64 位浮点型数值。{“x”：3.14}或{“x”：3}。对于整型值，可以使用NumberInt（4 字节符号整数）或NumberLong（8 字节符号整数），{“x”:NumberInt(“3”)}{“x”:NumberLong(“3”)}
...
options（更多选项）
![](images/MongoDB基础/image-20240419094155867.png)
提示：
...
![](images/MongoDB基础/image-20240419095139105.png)
